<template>
    <ConfirmDialog
        ...
        class="bg-timberwolf dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600"
    >
        <template #container="{ message, acceptCallback, rejectCallback }">
            ...
            <div class="pt-0 px-5 pb-5 flex justify-end gap-2">
                <SecondaryButton class="bg-white text-black-choco" @click="rejectCallback" :label="message.rejectProps.label" size="small" />
                <Button class="bg-ceil text-black-choco hover:bg-jp-indigo dark:hover:bg-independence" @click="acceptCallback" :label="message.acceptProps.label" size="small" />
            </div>
        </template>
    </ConfirmDialog>
</template>
...
import { ptViewMerge } from './utils.ts';
