                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg dark:bg-gray-800">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        ...
                        <nav class="flex items-center flex-column flex-wrap md:flex-row justify-between py-2 px-4" aria-label="Table navigation">
                            <span class="text-sm font-normal text-gray-700 mb-4 md:mb-0 block w-full md:inline md:w-auto dark:text-gray-100">Showing <span class="font-semibold text-gray-700 dark:text-gray-100">1-{{ maya_accounts.length }}</span> of <span class="font-semibold text-gray-700 dark:text-gray-100">1</span></span>
