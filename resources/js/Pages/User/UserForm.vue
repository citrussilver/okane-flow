        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-6 gap-6">
                ...
                <ElementsGrouper>
                    ...
                    <select name="role_id" v-model="form.role_id" id="role_id" class="shadow-xs border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-indigo-600 dark:focus:ring-indigo-600">
                ...
                <BlockWideElementsGrouper>
                    ...
                    <Link :href="route('users.index')" as="button" class="text-gray-900 bg-white border border-gray-300 focus:outline-hidden hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-5 py-2.5">Cancel</Link>
                </BlockWideElementsGrouper>
