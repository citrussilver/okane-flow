...
const { confirmDelete } = useCrud('maya-transactions', { toast: true });
            ...
            <div class="mx-auto max-w-screen sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xs sm:rounded-lg dark:bg-gray-800">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                        <div class="p-4">
                            <DataTable 
                                :cols="consts.MAYA_TRANSACTS_COLS" 
                                :rows="maya_transactions" 
                                @edit-row="(row) => router.visit(route('maya-transactions.edit', row.id))" 
