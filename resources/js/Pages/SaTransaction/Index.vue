...
const { confirmDelete } = useCrud('sa-transactions', { toast: true });
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            <div class="mx-auto max-w-screen sm:px-6 lg:px-8">
                <div class="bg-white p-3 overflow-hidden shadow-xs sm:rounded-lg dark:bg-gray-800">
                    <div class="m-4 flex justify-between" v-if="form.role_id == 1">
                        ...
                        <Link 
                            :href="route('sa-transactions.create')" 
                            class="bg-ceil hover:bg-jp-indigo px-4 py-1 rounded-full text-white active:translate-y-1"
                        >
                            + SA Transaction
                        </Link>
                    </div>
                    ...
                    <div class="p-4 relative overflow-x-auto shadow-md sm:rounded-lg">
                        <DataTable 
                            :cols="consts.SA_TRANSACTS_COLS" 
                            :rows="sa_transactions" 
